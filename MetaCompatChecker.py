...
from mutil import loadJsonData, dumpJsonData, pureName, setUpLog
import os
import sys
import json
import logging
						...
						for updatePlan in updatePlans:
							for updateType in updatePlan['update_types']:
								if updateType == 'add_default':
									print('add default value',updatePlan['new_default'],'for attr',id2Name[updatePlan['attrId']])
								elif updateType == 'delete_default':
									print('remove default value',updatePlan['old_default'],'for attr',id2Name[updatePlan['attrId']])
								elif updateType == 'update_default':
									print('update default value',updatePlan['old_default'],'->',updatePlan['new_default'],'for attr',id2Name[updatePlan['attrId']])
								elif updateType == 'type_change':
									hasTypeChange = True
									print('change type',updatePlan['old_type'],'->',updatePlan['new_type'],'for attr',id2Name[updatePlan['attrId']])
									changeTableEntry = {
										'level': levelFn,
