...
from PyQt5.QtWidgets import QGraphicsLineItem, QGraphicsItem, QGraphicsScene, QLabel, QLineEdit, QPushButton, \
    QGridLayout, QWidget, QVBoxLayout, QMainWindow, QHBoxLayout, QGraphicsView, QAction, QButtonGroup, QToolButton, \
